<?php
  ...
  $uID = $_POST['user_id'];
  if ($db_found) {
    //$query = "SELECT course.id,course.course_name,jnct_user_course.semester FROM user JOIN jnct_user_course ON $uID = jnct_user_course.User_ID_FK JOIN course ON course.id = jnct_user_course.Course_ID_FK";
    $query = "SELECT course.id,course.course_name,jnct_user_course.semester FROM user JOIN jnct_user_course ON user.id = jnct_user_course.User_ID_FK JOIN course ON course.id = jnct_user_course.Course_ID_FK WHERE user.id = $uID";
